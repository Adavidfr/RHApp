...
|---|---|---|---|
| **Administrador** | `admin` | `admin123` *(o contraseña configurada)* | Acceso al panel de administración, CRUD de las 5 entidades. |
| **Empleado Básico** | `empleado1` | `empleado123` | Acceso a consulta de perfil propio, registro de asistencias, visualización de nóminas asignadas. |
